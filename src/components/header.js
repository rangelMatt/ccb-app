...
function Header() {
  return (
    <>
      ...
      <meta name="Fitness center in Grover Beach Arroyo Grande Oceano Pismo Beach Avila San Luis Obispo Gym Barbell Strongman Strong Man Body Building Fitness Crossfit Cross Fit exercise fitness training health and well ness lose weight nutrition shape studio weight lifting workout "></meta>
      {/* </head> */}
      ...
      <header className="App-header" id="App-header">
        <section
          className="Title"
          alt="Central Coast Barbell Gym Membership Open Twenty Four Hours. "
        >
          <img
          ...
          <h5
            ...
            alt="Fitness Bodybuilding BodyBuilder Powerlifting Powerlifter lift Exercise"
          >
      ...
      <section className="logos">
        <img src={icarian} alt="icarian equipment" aria-label="*"></img>
        <img
          src={hammerStrength}
      ...
      <main className="Office-Info Grover Beach Oceano Arroyo Grande Pismo Nipomo Avila SLO San Luis Obispo">
        ...
        <div className="about-gym">
          <h3>
            ...
            <br />
            <br />
            We offer Free Weights, Specialty Bars, Selectorized (cable)
            Machines, Plate Loaded Machines, Chalk, Cardio Equipment,
            Powerlifting Equipment, Strongman Equipment.
            <br />
            <br />
