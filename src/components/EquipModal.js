  ...
  return (
    <div id="equip">
      <head>
        ...
        <meta
          name="Not only the best equipment for body building, strongman, crossfit, but for the general fitness enthusiast as well. Treadmill, step machine, elliptical."></meta>
      </head>
