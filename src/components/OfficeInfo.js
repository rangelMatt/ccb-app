  ...
  return (
    <>
      <head>
        ...
        <meta
          name="Located in Grover Beach with an owner very close. Security cameras monitor the fitness floor and parking lot. There is a number lock at front door."></meta>
      </head>
      <div id="officeinfo">
